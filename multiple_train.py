...
def scene_reconstruction(dataset, opt, hyper, pipe, testing_iterations, saving_iterations, 
    ...
    for iteration in range(first_iter, final_iter+1):        
        ...
        while network_gui.conn != None:
            try:
                ...
                if custom_cam != None:
                    ...
                    net_image = render(custom_cam, gaussians, pipe, background, scaling_modifer, action = None, stage=stage, cam_type=scene.dataset_type)["render"]
        ...
        for viewpoint_cam in viewpoint_cams:
            render_pkg = render(viewpoint_cam, gaussians, pipe, background, action = None, stage=stage,cam_type=scene.dataset_type)
        ...
        loss.backward()
        #for name, param in gaussians._deformation.deformation_net.action_out.named_parameters():
            #print(param.grad)
